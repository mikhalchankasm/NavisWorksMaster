...
| `viewpoint_set_camera` | landed 2026-09-26; measured at NW-02 acceptance. |
...
- **one short window away** — the remaining **1**: `viewpoint_set_camera`, which landed
  2026-09-26 and is measured at the NW-02 acceptance. The eight that were one window away
