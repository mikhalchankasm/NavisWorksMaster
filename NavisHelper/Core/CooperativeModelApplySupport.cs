...
namespace NavisHelper.Core
{
    ...
    internal sealed class CooperativeModelOperationTimingSnapshot
    {
        ...
        /// the whole scan result). The apply is atomic by design: cancel is
        /// honored before it and the operation completes inside it, so this
        /// number is the measured upper bound of the apply-phase UI stall.
        /// </summary>
